...
\newcommand{\orcJR}{0000-0001-8217-1484} % J. Rafelski
%\newcommand{\orcCTY}{0000-0001-5038-8427} % C. T. Yang
\newcommand{\orcAJS}{0000-0001-5474-2649} % A. Steinmetz
%\newcommand{\orcMF}{0000-0003-2704-6474} % M. Formanek
%\newcommand{\orcJB}{0000-0002-2289-4856} % J. Birrell
%\newcommand{\orcSE}{0000-0001-5884-5047} % S. Evans
...
%\title[Magnetized primordial quark-gluon plasma]{Magnetized primordial quark-gluon plasma}
\title[Short note on spin magnetization in primordial QGP]{Short note on spin magnetization in primordial quark-gluon plasma}

\author[1]{\fnm{Andrew} \sur{Steinmetz\orc{\orcAJS}}}\email{ajsteinmetz@arizona.edu}

\author[1]{\fnm{Johann} \sur{Rafelski\orc{\orcJR}}}\email{johannr@arizona.edu}

\affil[1]{\orgdiv{Department of Physics}, \orgname{The University of Arizona}, \orgaddress{\city{Tucson}, \postcode{85721}, \state{AZ}, \country{USA}}}
...
\keywords{quark-gluon plasma, magnetism, magnetic moment, primordial Universe}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Quark-gluon plasma (QGP) is a state of matter that existed microseconds after the Big Bang, where quarks and gluons were not confined within hadrons but existed as a free deconfined plasma~\cite{Letessier:2002ony,Rafelski:2015cxa,Rafelski:2023emw,Rafelski:2024fej,Shuryak:2004cy,HotQCD:2014kol}. Understanding the properties of QGP is crucial for determining the conditions of the primordial Universe and the formation of matter as we observe it today~\cite{Uzan:2010pm,Uzan:2024ded,Grasso:2000wj,Widrow:2002ud,Kandus:2010nw}.
...
\begin{tabular}{@{}lll@{}}
\toprule
\textbf{Particle} & \textbf{Mass} \([\approx\mathrm{MeV}]\) & \textbf{Magneton} \([\mu_{f}/\mu_{B}]\) \\ \midrule
Up \((u)\) & 2.2 & \(1.55\times10^{-1}\) \\
Down \((d)\) & 4.7 & \(3.62\times10^{-2}\) \\
Strange \((s)\) & 96 & \(1.77\times10^{-3}\) \\
Electron \((e)\) & 0.511 & \( 1 \) \\ \bottomrule
\end{tabular}
\end{table}
...
\begin{align}
    \notag\mu_{u}&=+\frac{2}{3}\left|\frac{g_{u}}{2}\right|\frac{e\hbar}{2m_{u}}\,,&\qquad
    \mu_{d}&=-\frac{1}{3}\left|\frac{g_{d}}{2}\right|\frac{e\hbar}{2m_{d}}\,,&\\
    \label{eq:moments}
