...
\begin{align}
\label{eq:UpQuarkMagnetization}
\mathcal{B}_{u\bar{u}}(T)<\mu_{0}\mu_{u}(n_{u}(T)+n_{\bar{u}}(T))=\mu_{0}\mu_{u}\frac{2\mathfrak{g}_{u}}{\pi^{2}}\frac{3\zeta(3)}{2}\left(\frac{k_{B}T}{\hbar c}\right)^{3}\,,
\end{align}
